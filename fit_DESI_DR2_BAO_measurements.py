...
def plot_fit_combined_wCDM():
    ...
    plt.savefig('/home/etudiant15/Documents/STAGE CPPM/Figures/chi_combined_DESI_DR2_wCDM.pdf', bbox_inches='tight')
    plt.show()
    return m, pars_fit
...
def plot_fit_combined_error_bar_wCDM():
    ...
    m.migrad() # finds minimum of least_squares function
    m.minos() 
    m.draw_mncontour("Omega_m", "W_0", cl=(0.683, 0.954,), size=300)
    plt.xlim(0.1, 0.5)
    plt.ylim(-2.0, 0.0)
    plt.axhline(-1, color='black', ls=':')
    plt.savefig('/home/etudiant15/Documents/STAGE CPPM/Figures/mncontour_DR2_wCDM.pdf', bbox_inches='tight')
    ...
    plt.savefig('/home/etudiant15/Documents/STAGE CPPM/Figures/chi_combined_DESI_DR2_error_bar_wCDM.pdf', bbox_inches='tight')
    plt.show()
