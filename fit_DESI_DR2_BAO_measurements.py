...
def iminuit_Dv_over_rd():
    cost = LeastSquares(
        z_Dv, DV_over_rd_exp, sigma_DV_over_rd, model_wrapper_Dv_over_rd
    )
    m = Minuit(
        cost,
        Omega_m=0.3,
    ...
    plt.savefig(
        "/home/etudiant15/Documents/STAGE CPPM/Figures/Dv_over_rd_DESI_DR2.pdf",
        bbox_inches="tight",
    )
    plt.show()
    return m, pars_fit
...
def iminuit_DM_over_DH():
    cost = LeastSquares(
        z_DM, DM_over_DH_exp, sigma_DM_over_DH, model_wrapper_DM_over_DH
    )
    m = Minuit(
        cost,
        Omega_m=0.3,
    ...
    plt.grid(True, alpha=0.3)
    plt.savefig(
        "/home/etudiant15/Documents/STAGE CPPM/Figures/DM_over_DH_DESI_DR2.pdf",
        bbox_inches="tight",
    )
    plt.show()
    return m, pars_fit
...
def plot_Dv_over_rd_th():
    ...
    axs[1].errorbar(
        z_Dv, residu, yerr=1, color="black", ecolor="red", fmt="o", label="BAO"
    )
    axs[1].set_xlabel("$z$")
...
def plot_fit_Dv_over_rd_error_bar():
    ...
    axs[1].legend()
    plt.savefig(
        "/home/etudiant15/Documents/STAGE CPPM/Figures/Dv_over_rd_DESI_DR2_double.pdf",
        bbox_inches="tight",
    )
    plt.show()
    return m, pars_fit
...
def plot_fit_DM_over_DH_error_bar():
    ...
    axs[1].legend()
    plt.savefig(
        "/home/etudiant15/Documents/STAGE CPPM/Figures/DM_over_DH_DESI_DR2_double.pdf",
        bbox_inches="tight",
    )
    plt.show()
    return m, pars_fit
...
def plot_fit_combined():
    ...
    chi2_DM = np.sum(
        (
            (DM_over_DH_exp - model_wrapper_DM_over_DH(z_DM, *m.values))
            / sigma_DM_over_DH
        )
        ** 2
    )
    chi2_DV = np.sum(
        (
            (DV_over_rd_exp - model_wrapper_Dv_over_rd(z_Dv, *m.values))
            / sigma_DV_over_rd
        )
        ** 2
    )
    ...
    plt.savefig(
        "/home/etudiant15/Documents/STAGE CPPM/Figures/chi_combined_DESI_DR2.pdf",
        bbox_inches="tight",
    )
    plt.show()
    return m, pars_fit
...
def plot_fit_combined_error_bar():
    ...
    plt.savefig(
        "/home/etudiant15/Documents/STAGE CPPM/Figures/chi_combined_DESI_DR2_error_bar.pdf",
        bbox_inches="tight",
    )
    plt.show()
    ...
    print(
        f'BAO & ${m.values["Omega_m"]:.3f}^{{+{upper_m:.3f}}}_{{{- inf_m:.3f}}}$ & ${m.values["W_0"]:.3f}^{{+{upper_0:.3f}}}_{{{- inf_0:.3f}}}$ & ${m.values["W_a"]:.3f}^{{+{upper_a:.3f}}}_{{{- inf_a:.3f}}}$ & - & ${m.values["H_0xr_d"]:.3f}^{{+{upper_H:.3f}}}_{{{- inf_H:.3f}}}$ & {m.fval:.2f} & {m.ndof}$'
    )
    return m, pars_fit
...
def plot_fit_combined_wCDM():
    ...
    plt.savefig(
        "/home/etudiant15/Documents/STAGE CPPM/Figures/chi_combined_DESI_DR2_wCDM.pdf",
        bbox_inches="tight",
    )
    plt.show()
    return m, pars_fit
...
def plot_fit_combined_error_bar_wCDM():
    cost_DM = LeastSquares(
        z_DM, DM_over_DH_exp, sigma_DM_over_DH, model_wrapper_DM_over_DH
    )
    cost_Dv = LeastSquares(
    ...
    """intermédiaire : #ON FIXE W_a et H_0 n'est plus fixe
    m.limits['Omega_m'] = (0.1, 1.0)
    #m.limits['Omega_Lambda'] = (0.0, 1.0)
    m.limits['W_0'] = (-3.0, 1.0)
    #m.limits['W_a'] = (-3.0, 2.0)
    ...
    plt.savefig(
        "/home/etudiant15/Documents/STAGE CPPM/Figures/chi_combined_DESI_DR2_error_bar_wCDM.pdf",
        bbox_inches="tight",
    )
    plt.show()
    ...
    print(
        f'BAO & ${m.values["Omega_m"]:.3f}^{{+{upper_m:.3f}}}_{{{- inf_m:.3f}}}$ & ${m.values["W_0"]:.3f}^{{+{upper_0:.3f}}}_{{{- inf_0:.3f}}}$ & 0 & - & ${m.values["H_0xr_d"]:.3f}^{{+{upper_H:.3f}}}_{{{- inf_H:.3f}}}$ & {m.fval:.2f} & {m.ndof:.0f}'
    )
    return m, pars_fit
